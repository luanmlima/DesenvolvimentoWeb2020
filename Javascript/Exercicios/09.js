...
Se a nota for abaixo de 38, não é feito nenhum arredondamento pois esta nota resulta
na reprovação do aluno. Por exemplo, a nota 84 será arredondada para 85,
...
function Notas(nota) {
    if (nota < 38) {
        ...
        for (let i = 1; i < 3; i++){
            if(nota % 5 !== 0){
               console.log(`incremento ${nota+=1}`)
            }
        }
        return console.log('Você passou')
    }
}
