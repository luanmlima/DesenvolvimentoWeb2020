...
Outra coisa importante de observar, é o fato que o ponto é utilizado no
lugar da vírgula e vice versa. Com isso, vamos fazer um exercício simples
...
const money = (num1, num2) => { 
     resultado = num1 + num2
     return console.log(`R$${resultado.toFixed(2).toString().replace('.', ',')}`)
 }
